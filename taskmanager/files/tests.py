...
class FileTests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.initial_file = SimpleUploadedFile(
            "testfile.pdf", cls.initial_file_content, content_type="application/pdf"
        )
    ...
    def test_file_list(self):
        ...
        SharedFile.objects.create(
            uploaded_by=self.user, file=self.initial_file, project=self.project
        )
        SharedFile.objects.create(
            uploaded_by=self.user, file=self.initial_file, project=self.project
        )
    ...
    def test_invalid_file_extension(self):
        ...
        invalid_file = SimpleUploadedFile(
            "testfile.exe", b"Hello, World!", content_type="text/plain"
        )
